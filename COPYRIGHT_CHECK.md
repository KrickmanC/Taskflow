...
To verify that all tracked Python files contain the correct copyright header for **Taskflow Software Inc.** for the year **2023**, run this command from the repository root:
...
- **`-c "Taskflow Software Inc."`**: sets the copyright holder.
