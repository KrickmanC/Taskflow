...
import type { IFormattedInstanceConfiguration, TInstanceEmailConfigurationKeys } from "@taskflow/types";
// ui
import { CustomSelect } from "@taskflow/ui";
// components
...
export function InstanceEmailForm(props: IInstanceEmailForm) {
  ...
  const emailFormFields: TControllerInputFormField[] = [
    ...
    },
    {
      ...
      placeholder: "no-reply@projecttaskflow.so",
  ...
  const OptionalEmailFormFields: TControllerInputFormField[] = [
    {
      ...
      type: "text",
      label: "Username",
      placeholder: "getitdone@projecttaskflow.so",
