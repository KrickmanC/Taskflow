...
import { WEB_BASE_URL } from "@taskflow/constants";
// taskflow internal packages
import { GithubIcon, NewTabIcon, PageIcon } from "@taskflow/propel/icons";
...
const helpOptions = [
  {
    name: "Documentation",
    href: "https://docs.taskflow.so/",
    Icon: PageIcon,
  },
  {
    name: "Join our Forum",
    href: "https://forum.taskflow.so",
    Icon: MessageSquare,
  },
  {
    name: "Report a bug",
    href: "https://github.com/taskflow/taskflow/issues/new/choose",
    Icon: GithubIcon,
  },
];
  ...
  return (
    ...
    >
      <div className={`flex items-center gap-1 ${isSidebarCollapsed ? "flex-col justify-center" : "w-full"}`}>
        <Tooltip tooltipContent="Redirect to Taskflow" position="right" className="ml-4" disabled={!isSidebarCollapsed}>
          <a
          ...
          >
            ...
            {!isSidebarCollapsed && "Redirect to Taskflow"}
          </a>
        </Tooltip>
