...
import { API_BASE_URL, E_PASSWORD_STRENGTH } from "@taskflow/constants";
import { Button } from "@taskflow/propel/button";
import { AuthService } from "@taskflow/services";
import { Checkbox, Input, PasswordStrengthIndicator, Spinner } from "@taskflow/ui";
import { getPasswordStrength, validatePersonName, validateCompanyName } from "@taskflow/utils";
// components
    ...
    <>
      ...
      <div className="mt-10 flex w-full flex-grow flex-col items-center justify-center py-6">
        <div className="relative flex w-full max-w-[22.5rem] flex-col gap-6">
          <FormHeader
            heading="Setup your Taskflow Instance"
            subHeading="Post setup you will be able to manage this Taskflow instance."
          />
          {errorData.type &&
            errorData?.message &&
          ...
          >
            ...
            <div className="relative flex gap-2">
              ...
              <label className="cursor-pointer text-13 font-medium text-tertiary" htmlFor="is_telemetry_enabled">
                Allow Taskflow to anonymously collect usage events.{" "}
                <a
                  tabIndex={-1}
                  href="https://developers.taskflow.so/self-hosting/telemetry"
                  target="_blank"
