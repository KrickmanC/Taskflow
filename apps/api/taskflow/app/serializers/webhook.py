...
from taskflow.db.models import Webhook, WebhookLog
from taskflow.db.models.webhook import validate_domain, validate_schema
...
class WebhookSerializer(DynamicBaseSerializer):
    ...
    def create(self, validated_data):
        ...
        disallowed_domains = ["taskflow.so"]  # Add your disallowed domains here
        if request:
