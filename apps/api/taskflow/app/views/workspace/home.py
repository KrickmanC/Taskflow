...
from taskflow.db.models.workspace import WorkspaceHomePreference
from taskflow.app.permissions import allow_permission, ROLE
from taskflow.db.models import Workspace
from taskflow.app.serializers.workspace import WorkspaceHomePreferenceSerializer
...
class WorkspaceHomePreferenceViewSet(BaseAPIView):
    ...
    def get(self, request, slug):
        ...
        keys = [
            ...
            if key not in ["quick_tutorial", "new_at_taskflow"]
        ]
