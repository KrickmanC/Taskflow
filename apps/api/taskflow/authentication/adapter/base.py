...
from taskflow.bgtasks.user_activation_email_task import user_activation_email

# Module imports
from taskflow.db.models import FileAsset, Profile, User, WorkspaceMemberInvite
from taskflow.license.utils.instance_value import get_configuration_value
from taskflow.settings.storage import S3Storage
from taskflow.utils.exception_logger import log_exception
...
class Adapter:
    ...
    def __init__(self, request, provider, callback=None):
        ...
        self.user_data = None
        self.logger = logging.getLogger("taskflow.authentication")
