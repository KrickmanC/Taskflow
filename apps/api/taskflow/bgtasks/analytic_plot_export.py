...
# Module imports
from taskflow.db.models import Issue
from taskflow.license.utils.instance_value import get_email_configuration
from taskflow.utils.analytics_plot import build_graph_plot
from taskflow.utils.email import generate_plain_text_from_html
...
def analytic_export_task(email, data, slug):
    try:
        ...
        logging.getLogger("taskflow.worker").info("Email sent successfully.")
        return
