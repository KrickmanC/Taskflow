...
# Module imports
from taskflow.app.serializers import IssueActivitySerializer
from taskflow.bgtasks.notification_task import notifications
...
from taskflow.utils.issue_relation_mapper import get_inverse_relation
from taskflow.utils.uuid import is_valid_uuid
    ...
    if current_instance.get("archived_at") != requested_data.get("archived_at"):
        if requested_data.get("archived_at") is None:
            ...
            if requested_data.get("automation"):
                comment = "Taskflow has archived the issue"
                new_value = "archive"
            else:
    ...
    if requested_data.get("closed_to") is not None:
        ...
        issue_activities.append(
            IssueActivity(
                ...
                project_id=project_id,
                workspace_id=workspace_id,
                comment="Taskflow updated the state to ",
                old_identifier=None,
