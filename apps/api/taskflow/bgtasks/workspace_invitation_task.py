...
# Module imports
from taskflow.db.models import User, Workspace, WorkspaceMemberInvite
...
def workspace_invitation(email, workspace_id, token, current_site, inviter):
    try:
        ...
        subject = f"{user.first_name or user.display_name or user.email} has invited you to join them in {workspace.name} on Taskflow"  # noqa: E501
