...
import taskflow.db.models.api
import taskflow.db.models.webhook
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.URLField(
                        validators=[
                            taskflow.db.models.webhook.validate_schema,
                            taskflow.db.models.webhook.validate_domain,
                        ]
                    ),
                ),
                ...
                (
                    "secret_key",
                    models.CharField(
                        default=taskflow.db.models.webhook.generate_token,
                        max_length=255,
                    ),
                ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                db_index=True,
                default=taskflow.db.models.api.generate_token,
                max_length=255,
                unique=True,
            ),
        ),
