...
# Module imports
from taskflow.utils.html_processor import strip_tags
from taskflow.db.mixins import SoftDeletionManager
from taskflow.utils.exception_logger import log_exception
from .project import ProjectBaseModel
from taskflow.utils.uuid import convert_uuid_to_integer
from .description import Description
from taskflow.db.mixins import ChangeTrackerMixin
...
class Issue(ProjectBaseModel):
    ...
    def save(self, *args, **kwargs):
        if self.state is None:
            try:
                from taskflow.db.models import State
