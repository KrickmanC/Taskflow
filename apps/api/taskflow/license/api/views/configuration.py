...
from taskflow.license.models import InstanceConfiguration
from taskflow.license.api.serializers import InstanceConfigurationSerializer
from taskflow.license.utils.encryption import encrypt_data
from taskflow.utils.cache import cache_response, invalidate_cache
from taskflow.license.utils.instance_value import get_email_configuration
...
class EmailCredentialCheckEndpoint(BaseAPIView):
    def post(self, request):
        ...
        subject = "Email Notification from Taskflow"
        message = "This is a sample email notification sent from Taskflow application."
        # Send the email
        try:
