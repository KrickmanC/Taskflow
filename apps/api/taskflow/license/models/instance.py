...
# Module imports
from taskflow.db.models import BaseModel

ROLE_CHOICES = ((20, "Admin"),)


class InstanceEdition(Enum):
    TASKFLOW_COMMUNITY = "TASKFLOW_COMMUNITY"
...
class Instance(BaseModel):
    ...
    edition = models.CharField(max_length=255, default=InstanceEdition.TASKFLOW_COMMUNITY.value)
