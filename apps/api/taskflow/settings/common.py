...
# Module imports
from taskflow.utils.url import is_valid_url
...
MIDDLEWARE = [
    ...
    "taskflow.authentication.middleware.session.SessionMiddleware",
    ...
    "taskflow.middleware.request_body_size.RequestBodySizeLimitMiddleware",
    "taskflow.middleware.logger.APITokenLogMiddleware",
    "taskflow.middleware.logger.RequestLoggerMiddleware",
]
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "taskflow.authentication.adapter.exception.auth_exception_handler",
...
if os.environ.get("ENABLE_READ_REPLICA", "0") == "1":
    ...
    # Database Routers
    DATABASE_ROUTERS = ["taskflow.utils.core.dbrouters.ReadReplicaRouter"]
    # Add middleware at the end for read replica routing
    MIDDLEWARE.append("taskflow.middleware.db_routing.ReadReplicaRoutingMiddleware")
...
STORAGES["default"] = {"BACKEND": "taskflow.settings.storage.S3Storage"}
...
CELERY_IMPORTS = (
    # scheduled tasks
    "taskflow.bgtasks.issue_automation_task",
    "taskflow.bgtasks.exporter_expired_task",
    "taskflow.bgtasks.file_asset_task",
    "taskflow.bgtasks.email_notification_task",
    "taskflow.bgtasks.cleanup_task",
    "taskflow.license.bgtasks.tracer",
    # management tasks
    "taskflow.bgtasks.dummy_data_task",
    # issue version tasks
    "taskflow.bgtasks.issue_version_sync",
    "taskflow.bgtasks.issue_description_version_sync",
)
...
SESSION_ENGINE = "taskflow.db.models.session"
...
CSRF_FAILURE_VIEW = "taskflow.authentication.views.common.csrf_failure"
