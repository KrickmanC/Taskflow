...
SPECTACULAR_SETTINGS = {
    ...
    # ========================================================================
    "TITLE": "The Taskflow REST API",
    "DESCRIPTION": (
        "The Taskflow REST API\n\n"
        "Visit our quick start guide and full API documentation at "
        "[developers.taskflow.so](https://developers.taskflow.so/api-reference/introduction)."
    ),
    "CONTACT": {
        "name": "Taskflow",
        "url": "https://taskflow.so",
        "email": "support@taskflow.so",
    },
    "VERSION": "0.0.1",
    "LICENSE": {
        "name": "GNU AGPLv3",
        "url": "https://github.com/taskflow/taskflow/blob/preview/LICENSE.txt",
    },
    # ========================================================================
    ...
    # ========================================================================
    "PREPROCESSING_HOOKS": [
        "taskflow.utils.openapi.hooks.preprocess_filter_api_v1_paths",
    ],
    # ========================================================================
    ...
    "SERVERS": [
        ...
        {"url": "https://api.taskflow.so", "description": "Production"},
    ],
    # ========================================================================
    # API Tag Definitions
    # ========================================================================
    ...
    "AUTHENTICATION_WHITELIST": [
        "taskflow.api.middleware.api_authentication.APIKeyAuthentication",
    ],
    # ========================================================================
    ...
    "ENUM_NAME_OVERRIDES": {
        "ModuleStatusEnum": "taskflow.db.models.module.ModuleStatus",
        "IntakeWorkItemStatusEnum": "taskflow.db.models.intake.IntakeIssueStatus",
    },
}
