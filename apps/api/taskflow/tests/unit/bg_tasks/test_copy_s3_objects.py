...
import pytest
from taskflow.db.models import Project, ProjectMember, Issue, FileAsset
from unittest.mock import patch, MagicMock
from taskflow.bgtasks.copy_s3_object import (
...
class TestCopyS3Objects:
    ...
    @patch("taskflow.bgtasks.copy_s3_object.S3Storage")
    def test_copy_s3_objects_of_description_and_assets(
        ...
        with patch("taskflow.bgtasks.copy_s3_object.sync_with_external_service") as mock_sync:
