# SPDX-FileCopyrightText: 2023-present Taskflow Software, Inc.
# SPDX-License-Identifier: LicenseRef-Taskflow-Commercial
#
# Licensed under the Taskflow Commercial License (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
# https://taskflow.so/legals/eula
#
