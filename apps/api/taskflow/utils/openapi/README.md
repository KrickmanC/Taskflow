...
```python
from taskflow.utils.openapi import (
    asset_docs,
    ASSET_ID_PARAMETER,
...
```python
from taskflow.utils.openapi.decorators import asset_docs
from taskflow.utils.openapi.parameters import ASSET_ID_PARAMETER
from taskflow.utils.openapi.responses import UNAUTHORIZED_RESPONSE
```
...
### Files updated:
- `taskflow/api/views/asset.py` - All methods use new `@asset_docs` helpers
- `taskflow/api/views/project.py` - Import updated
- `taskflow/api/views/user.py` - Import updated  
- `taskflow/api/views/state.py` - Import updated
- `taskflow/api/views/intake.py` - Import updated
- `taskflow/api/views/member.py` - Import updated
- `taskflow/api/views/module.py` - Import updated
- `taskflow/api/views/cycle.py` - Import updated
- `taskflow/api/views/issue.py` - Import updated
- `taskflow/settings/common.py` - Hook paths updated
- `taskflow/api/apps.py` - Auth extension import updated
