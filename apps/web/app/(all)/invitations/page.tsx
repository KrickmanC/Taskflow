...
// taskflow imports
import { ROLE } from "@taskflow/constants";
...
import type { IWorkspaceMemberInvitation } from "@taskflow/types";
import { truncateText } from "@taskflow/utils";
// assets
    ...
    <AuthenticationWrapper>
      <div className="flex h-full flex-col gap-y-2 overflow-hidden sm:flex-row sm:gap-y-0">
        <div className="relative h-1/6 flex-shrink-0 sm:w-2/12 md:w-3/12 lg:w-1/5">
          ...
          >
            <TaskflowLogo className="h-9 w-auto text-primary" />
          </Link>
