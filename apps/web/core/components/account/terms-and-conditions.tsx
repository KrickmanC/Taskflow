...
import { EAuthModes } from "@taskflow/constants";
...
const LEGAL_LINKS = {
  termsOfService: "https://taskflow.so/legals/terms-and-conditions",
  privacyPolicy: "https://taskflow.so/legals/privacy-policy",
} as const;
