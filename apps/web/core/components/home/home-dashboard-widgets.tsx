...
import type { THomeWidgetKeys, THomeWidgetProps } from "@taskflow/types";
// assets
...
import { HomePageHeader } from "@/taskflow-web/components/home/header";
// local imports
...
export const HOME_WIDGETS_LIST: {
  ...
  new_at_taskflow: {
    component: null,
    fullWidth: false,
    title: "home.new_at_taskflow.title",
  },
  quick_tutorial: {
    component: null,
    fullWidth: false,
