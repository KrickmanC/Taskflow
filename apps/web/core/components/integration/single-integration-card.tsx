...
import type { IAppIntegration, IWorkspaceIntegration } from "@taskflow/types";
// ui
...
const integrationDetails: { [key: string]: any } = {
  github: {
    ...
    notInstalled: "Connect with GitHub with your Taskflow workspace to sync project work items.",
  },
  slack: {
    logo: SlackLogo,
    installed: "Activate Slack on individual projects to sync with specific channels.",
    notInstalled: "Connect with Slack with your Taskflow workspace to sync project work items.",
  },
};
