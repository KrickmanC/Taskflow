...
import { cn, getDate, renderFormattedPayloadDate, shouldHighlightIssueDueDate } from "@taskflow/utils";
// components
...
import { WorkItemAdditionalSidebarProperties } from "@/taskflow-web/components/issues/issue-details/additional-properties";
import { IssueParentSelectRoot } from "@/taskflow-web/components/issues/issue-details/parent-select-root";
import { DateAlert } from "@/taskflow-web/components/issues/issue-details/sidebar/date-alert";
import { TransferHopInfo } from "@/taskflow-web/components/issues/issue-details/sidebar/transfer-hop-info";
import { IssueWorklogProperty } from "@/taskflow-web/components/issues/worklog/property";
        ...
        {createdByDetails && (
          ...
          >
            ...
            <span className="grow truncate text-body-xs-medium leading-5 text-secondary">
              {createdByDetails?.display_name.includes("-intake") ? "Taskflow" : createdByDetails?.display_name}
            </span>
          </SidebarPropertyListItem>
        )}
