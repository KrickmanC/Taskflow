...
// taskflow imports
import { E_PASSWORD_STRENGTH } from "@taskflow/constants";
...
import { EOnboardingSteps } from "@taskflow/types";
import { cn, getFileURL, getPasswordStrength, validatePersonName } from "@taskflow/utils";
// components
...
export const ProfileSetupStep = observer(function ProfileSetupStep({ handleStepChange }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-10">
      {/* Header */}
      <CommonOnboardingHeader title="Create your profile." description="This is how you will appear in Taskflow." />
