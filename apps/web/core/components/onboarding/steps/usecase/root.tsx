...
// taskflow imports
import { USE_CASES } from "@taskflow/constants";
import { Button } from "@taskflow/propel/button";
import { CheckIcon } from "@taskflow/propel/icons";
import { TOAST_TYPE, setToast } from "@taskflow/propel/toast";
import type { TUserProfile } from "@taskflow/types";
...
export const UseCaseSetupStep = observer(function UseCaseSetupStep({ handleStepChange }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-10">
      {/* Header */}
      <CommonOnboardingHeader title="What brings you to Taskflow?" description="Tell us your goals and team size." />
