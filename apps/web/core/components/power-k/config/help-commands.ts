...
export const usePowerKHelpCommands = (): TPowerKCommandConfig[] => {
  ...
  return [
    ...
    {
      id: "open_taskflow_documentation",
      type: "action",
      group: "help",
      i18n_title: "power_k.help_actions.open_taskflow_documentation",
      icon: FileText,
      action: () => {
        window.open("https://docs.taskflow.so/", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
    },
    {
      ...
      icon: MessageSquare,
      action: () => {
        window.open("https://forum.taskflow.so", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
    },
    {
      ...
      icon: GithubIcon,
      action: () => {
        window.open("https://github.com/taskflow/taskflow/issues/new/choose", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
