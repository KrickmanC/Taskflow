...
// taskflow imports
import type { IUserActivityResponse } from "@taskflow/types";
import { calculateTimeAgo, getFileURL } from "@taskflow/utils";
// components
                        ...
                        <div className="min-w-0 flex-1 border-b border-subtle py-4">
                          <div className="text-13 break-words text-secondary">
                            {activityItem.field === "archived_at" && activityItem.new_value !== "restore" ? (
                              <span className="text-gray font-medium">Taskflow</span>
                            ) : activityItem.actor_detail.is_bot ? (
