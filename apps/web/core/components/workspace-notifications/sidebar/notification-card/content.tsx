...
// taskflow imports
import type { TNotification } from "@taskflow/types";
import {
...
import {
  ...
  shouldShowConnector,
} from "@/taskflow-web/components/workspace-notifications/notification-card/content";
...
const getNotificationContentDetails = (
  ...
  // Check additional map from taskflow-web (EE extensions)
