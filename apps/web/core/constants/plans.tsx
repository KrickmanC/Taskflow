...
export type TTaskflowPlans = "free" | "one" | "pro" | "business" | "enterprise";
...
type TPlanFeatureDetails = {
  ...
  cloud: Record<TTaskflowPlans, TPlanFeatureData>;
  "self-hosted"?: Record<TTaskflowPlans, TPlanFeatureData>;
};
...
type TaskflowPlans = {
  planDetails: Record<TTaskflowPlans, TPlanDetail>;
  planHighlights: Record<TTaskflowPlans, string[]>;
...
export const PLANS_LIST: TTaskflowPlans[] = ["free", "one", "pro", "business", "enterprise"];
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <a href="https://taskflow.so/talk-to-sales" target="_blank" rel="noopener noreferrer" className="underline">
              can be requested
            </a>
            .
          </>
...
export const TASKFLOW_PLANS: TaskflowPlans = {
  planDetails: {
    free: {
