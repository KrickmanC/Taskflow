...
import type { TProjectSettingsItem, TProjectSettingsTabs } from "@taskflow/types";
...
export const PROJECT_SETTINGS: Record<TProjectSettingsTabs, TProjectSettingsItem> = {
  ...
  parameters: {
    key: "parameters",
    i18n_label: "common.parameters",
    href: `/parameters`,
    access: [EUserProjectRoles.ADMIN],
    highlight: (pathname: string, baseUrl: string) => pathname === `${baseUrl}/parameters/`,
  },
  automations: {
    key: "automations",
