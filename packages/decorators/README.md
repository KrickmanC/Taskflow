...
This package is part of the Taskflow workspace and can be used by adding it to your project's dependencies:

```json
{
  "dependencies": {
    "@taskflow/decorators": "workspace:*"
  }
}
```
...
```typescript
import { Controller, Get, Post, BaseController } from "@taskflow/decorators";
...
```typescript
import { Controller, WebSocket, BaseWebSocketController } from "@taskflow/decorators";
