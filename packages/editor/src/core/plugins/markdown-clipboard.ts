...
// taskflow imports
import { convertHTMLToMarkdown } from "@taskflow/utils";
import type { TCustomComponentsMetaData } from "@taskflow/utils";
      ...
      handleDOMEvents: {
        copy: (view, event) => {
          try {
            ...
            event.clipboardData?.setData("text/taskflow-editor-html", clipboardHTML);
            return true;
          } catch (error) {
