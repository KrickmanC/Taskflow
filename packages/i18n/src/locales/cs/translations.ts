...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_taskflow: "Nový v Taskflow?",
  ...
  support: "Podpora",
  forum: "Forum",
  powered_by_taskflow_pages: "Poháněno Taskflow Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Většina věcí začíná projektem v Taskflow.",
        cta: "Začít",
      },
      invite_team: {
        title: "Pozvat tým",
  ...
  workspace_creation: {
    ...
    subheading: "Pro používání Taskflow musíte vytvořit nebo se připojit k pracovnímu prostoru.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Vítejte v Taskflow, jsme rádi, že jste zde. Vytvořte první projekt, sledujte pracovní položky a tato stránka se promění v prostor pro váš pokrok. Správci zde uvidí i položky pomáhající týmu.",
        primary_button: {
          text: "Vytvořte první projekt",
          comic: {
            title: "Vše začíná projektem v Taskflow",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Zkopírujte a uložte tento klíč do Taskflow Pages. Po zavření jej neuvidíte. CSV soubor s klíčem byl stažen.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Používejte API pro integraci Taskflow s externími systémy.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Taskflow bude automaticky archivovat pracovní položky, které byly dokončeny nebo zrušeny.",
        duration: "Automaticky archivovat pracovní položky, které jsou uzavřené po dobu",
      },
      "auto-close": {
        title: "Automaticky uzavírat pracovní položky",
        description: "Taskflow automaticky uzavře pracovní položky, které nebyly dokončeny nebo zrušeny.",
  ...
  self_hosted_maintenance_message: {
    taskflow_didnt_start_up_this_could_be_because_one_or_more_taskflow_services_failed_to_start:
      "Taskflow se nespustil. To může být způsobeno tím, že se jeden nebo více služeb Taskflow nepodařilo spustit.",
