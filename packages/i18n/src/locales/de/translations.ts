...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_taskflow: "Neu bei Taskflow?",
  ...
  support: "Support",
  forum: "Forum",
  powered_by_taskflow_pages: "Bereitgestellt von Taskflow Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Die meisten Dinge beginnen mit einem Projekt in Taskflow.",
        cta: "Los geht’s",
      },
      invite_team: {
        title: "Team einladen",
      ...
      personalize_account: {
        title: "Personalisieren Sie Taskflow.",
  ...
  workspace_creation: {
    ...
    subheading: "Um Taskflow verwenden zu können, müssen Sie einen Arbeitsbereich erstellen oder beitreten.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Willkommen bei Taskflow, wir freuen uns, dass Sie hier sind. Erstellen Sie Ihr erstes Projekt, verfolgen Sie Arbeitselemente und diese Seite verwandelt sich in einen Ort für Ihren Fortschritt. Administratoren sehen hier zusätzlich teamrelevante Elemente.",
        primary_button: {
          text: "Erstes Projekt erstellen",
          comic: {
            title: "Alles beginnt mit einem Projekt in Taskflow",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Kopieren Sie diesen Schlüssel und fügen Sie ihn in Taskflow Pages ein. Nach dem Schließen können Sie ihn nicht mehr sehen. Eine CSV-Datei mit dem Schlüssel wurde heruntergeladen.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Verwenden Sie die API, um Taskflow mit externen Systemen zu integrieren.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Taskflow wird Arbeitselemente automatisch archivieren, die abgeschlossen oder abgebrochen wurden.",
        duration: "Arbeitselemente automatisch archivieren, die seit",
      },
      "auto-close": {
        title: "Arbeitselemente automatisch schließen",
        description:
          "Taskflow wird Arbeitselemente automatisch schließen, die nicht abgeschlossen oder abgebrochen wurden.",
    ...
    features: {
      cycles: {
        ...
        short_title: "Zyklen",
        description:
          "Taskflown Sie die Arbeit in flexiblen Zeiträumen, die sich dem einzigartigen Rhythmus und Tempo dieses Projekts anpassen.",
        toggle_title: "Zyklen aktivieren",
        toggle_description: "Taskflown Sie die Arbeit in fokussierten Zeiträumen.",
      },
      modules: {
        title: "Module",
        short_title: "Module",
  ...
  self_hosted_maintenance_message: {
    taskflow_didnt_start_up_this_could_be_because_one_or_more_taskflow_services_failed_to_start:
      "Taskflow ist nicht gestartet. Dies könnte daran liegen, dass einer oder mehrere Taskflow-Services nicht starten konnten.",
