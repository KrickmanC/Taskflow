...
export default {
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Most things start with a project in Taskflow.",
        cta: "Get started",
      },
      invite_team: {
  ...
  workspace_creation: {
    ...
    subheading: "To start using Taskflow, you need to create or join a workspace.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Welcome to Taskflow, we are excited to have you here. Create your first project and track your work items, and this page will transform into a space that helps you progress. Admins will also see items which help their team progress.",
        primary_button: {
          text: "Build your first project",
          comic: {
            title: "Everything starts with a project in Taskflow",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copy and save this secret key in Taskflow Pages. You can't see this key after you hit Close. A CSV file containing the key has been downloaded.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Any application using this token will no longer have the access to Taskflow data. This action cannot be undone.",
          success: {
            title: "Success!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "Taskflow APIs can be used to integrate your data in Taskflow with any external system. Create a token to get started.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Get started by creating a new work item! Add details and properties to it. Explore more in Taskflow to see your activity.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    parameters: {
      heading: "Parameters",
      description: "Define project-specific fields to capture structured details on work items.",
      add: "Add parameter",
      edit: "Edit parameter",
      empty_title: "No parameters yet",
      empty_description: "Create parameters to capture the details your team needs on each work item.",
      fields: {
        name: "Name",
        key: "Key",
        description: "Description",
      ...
      toasts: {
        ...
        deleted: "Parameter archived successfully",
        error: "Parameter could not be saved. Please try again.",
      },
    },
    automations: {
      label: "Automations",
      ...
      "auto-archive": {
        ...
        description: "Taskflow will auto archive work items that have been completed or canceled.",
        duration: "Auto-archive work items that are closed for",
      },
      "auto-close": {
        title: "Auto-close work items",
        description: "Taskflow will automatically close work items that haven't been completed or canceled.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Work items are building blocks in Taskflow.",
            description:
              "Redesign the Taskflow UI, Rebrand the company, or Launch the new fuel injection system are examples of work items that likely have sub-work items.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Write a note, a doc, or a full knowledge base. Get Galileo, Taskflow's AI assistant, to help you get started",
        description:
          "Pages are thoughts potting space in Taskflow. Take down meeting notes, format them easily, embed work items, lay them out using a library of components, and keep them all in your project's context. To make short work of any doc, invoke Galileo, Taskflow's AI, with a shortcut or the click of a button.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    taskflow_didnt_start_up_this_could_be_because_one_or_more_taskflow_services_failed_to_start:
      "Taskflow didn't start up. This could be because one or more Taskflow services failed to start.",
  ...
  power_k: {
    ...
    help_actions: {
      ...
      open_taskflow_documentation: "Open Taskflow documentation",
