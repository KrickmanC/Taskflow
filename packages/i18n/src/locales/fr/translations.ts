...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_taskflow: "Nouveau sur Taskflow ?",
  ...
  support: "Support",
  forum: "Forum",
  powered_by_taskflow_pages: "Propulsé par Taskflow Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "La plupart des choses commencent par un projet dans Taskflow.",
        cta: "Commencer",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Faites de Taskflow le vôtre.",
  ...
  workspace_creation: {
    ...
    subheading: "Pour commencer à utiliser Taskflow, vous devez créer ou rejoindre un espace de travail.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Bienvenue sur Taskflow, nous sommes ravis de vous avoir parmi nous. Créez votre premier projet et suivez vos éléments de travail, et cette page se transformera en un espace qui vous aide à progresser. Les administrateurs verront également les éléments qui aident leur équipe à progresser.",
        primary_button: {
          text: "Construisez votre premier projet",
          comic: {
            title: "Tout commence par un projet dans Taskflow",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copiez et sauvegardez cette clé secrète dans Taskflow Pages. Vous ne pourrez plus voir cette clé après avoir cliqué sur Fermer. Un fichier CSV contenant la clé a été téléchargé.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Toute application utilisant ce jeton n’aura plus accès aux données de Taskflow. Cette action ne peut pas être annulée.",
          success: {
            title: "Succès !",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "Les API Taskflow peuvent être utilisées pour intégrer vos données dans Taskflow avec n’importe quel système externe. Créez un jeton pour commencer.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Commencez par créer un nouvel élément de travail ! Ajoutez-y des détails et des propriétés. Explorez davantage Taskflow pour voir votre activité.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Taskflow archivera automatiquement les éléments de travail qui ont été complétés ou annulés.",
      ...
      "auto-close": {
        ...
        description: "Taskflow fermera automatiquement les éléments de travail qui n’ont pas été complétés ou annulés.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Les éléments de travail sont les blocs de construction dans Taskflow.",
            description:
              "Refondre l’interface de Taskflow, Renouveler l’image de marque de l’entreprise, ou Lancer le nouveau système d’injection de carburant sont des exemples d’éléments de travail qui ont probablement des sous-éléments.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Rédigez une note, un document ou une base de connaissances complète. Obtenez l’aide de Galileo, l’assistant IA de Taskflow, pour commencer",
        description:
          "Les Pages sont un espace de réflexion dans Taskflow. Prenez des notes de réunion, formatez-les facilement, intégrez des éléments de travail, disposez-les à l’aide d’une bibliothèque de composants, et gardez-les tous dans le contexte de votre projet. Pour faciliter la rédaction de tout document, faites appel à Galileo, l’IA de Taskflow, avec un raccourci ou un clic sur un bouton.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    taskflow_didnt_start_up_this_could_be_because_one_or_more_taskflow_services_failed_to_start:
      "Taskflow n’a pas démarré. Cela pourrait être dû au fait qu’un ou plusieurs services Taskflow ont échoué à démarrer.",
