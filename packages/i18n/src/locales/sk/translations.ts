...
export default {
  ...
  support: "Podpora",
  forum: "Forum",
  powered_by_taskflow_pages: "Poháňa Taskflow Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Väčšina vecí začína projektom v Taskflow.",
        cta: "Začať",
      },
      invite_team: {
        title: "Pozvať tím",
  ...
  workspace_creation: {
    ...
    subheading: "Na používanie Taskflow musíte vytvoriť alebo sa pripojiť k pracovnému priestoru.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Vitajte v Taskflow, teší nás, že ste tu. Vytvorte prvý projekt, sledujte pracovné položky a táto stránka sa zmení na priestor pre váš pokrok. Správcovia tu uvidia aj položky pomáhajúce tímu.",
        primary_button: {
          text: "Vytvorte prvý projekt",
          comic: {
            title: "Všetko začína projektom v Taskflow",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Skopírujte a uložte tento kľúč do Taskflow Pages. Po zatvorení ho neuvidíte. CSV súbor s kľúčom bol stiahnutý.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Používajte API na integráciu Taskflow s externými systémami.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Taskflow bude archivovať dokončené alebo zrušené položky.",
        duration: "Archivovať položky uzavreté dlhšie ako",
      },
      "auto-close": {
        title: "Automaticky uzatvárať položky",
        description: "Taskflow uzavrie neaktívne položky.",
  ...
  self_hosted_maintenance_message: {
    taskflow_didnt_start_up_this_could_be_because_one_or_more_taskflow_services_failed_to_start:
      "Taskflow sa nespustil. Toto môže byť spôsobené tým, že sa jedna alebo viac služieb Taskflow nepodarilo spustiť.",
