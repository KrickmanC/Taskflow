...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_taskflow: "Вперше в Taskflow?",
  ...
  support: "Підтримка",
  forum: "Forum",
  powered_by_taskflow_pages: "Працює на Taskflow Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Більшість речей починається з проєкту в Taskflow.",
        cta: "Почати",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Налаштуйте Taskflow під себе.",
  ...
  workspace_creation: {
    ...
    subheading: "Щоб користуватися Taskflow, вам потрібно створити або приєднатися до робочого простору.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Ласкаво просимо до Taskflow, ми раді, що ви з нами. Створіть перший проєкт, додайте робочі одиниці — і ця сторінка заповниться вашим прогресом. Адміністратори побачать тут також важливі елементи для команди.",
        primary_button: {
          text: "Створіть перший проєкт",
          comic: {
            title: "Усе починається з проєкту в Taskflow",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Скопіюйте й збережіть цей ключ для Taskflow Pages. Після закриття ви його більше не побачите. CSV-файл із ключем було завантажено.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Використовуйте API, щоб інтегрувати Taskflow із зовнішніми системами.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Taskflow архівуватиме завершені або скасовані одиниці.",
        duration: "Архівувати одиниці, закриті понад",
      },
      "auto-close": {
        title: "Автоматично закривати одиниці",
        description: "Taskflow закриватиме неактивні одиниці.",
  ...
  self_hosted_maintenance_message: {
    taskflow_didnt_start_up_this_could_be_because_one_or_more_taskflow_services_failed_to_start:
      "Taskflow не запустився. Це може бути через те, що один або декілька сервісів Taskflow не змогли запуститися.",
  ...
  power_k: {
    ...
    help_actions: {
      ...
      open_taskflow_documentation: "Відкрити документацію Taskflow",
